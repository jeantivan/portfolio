...
import { MAIN_SKILLS, PROJECT_EXAMPLE } from "@utils/constants";
import { TSkill, TProject } from "@utils/types";
...
const ProjectsByType: NextPage<PageProps> = ({ skill, projects }) => {
